...
from mcp_proxy.service.session.models import McpProxySession, ClientInfo, ClientCapabilities, SessionState
...
class SessionManager:
    ...
    async def _save(self, session: McpProxySession):
        ...
        await self._redis.setex(self._key(session.session_id), settings.session_ttl_seconds, data)
